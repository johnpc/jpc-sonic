...
// Configure system prompt from environment variable
const SYSTEM_PROMPT = process.env.SYSTEM_PROMPT || 
    "You are a friend. The user and you will engage in a spoken " +
    "dialog exchanging the transcripts of a natural real-time conversation. Keep your responses short, " +
    "generally two or three sentences for chatty scenarios.";

// Configure AWS credentials with environment variable support
function getAwsCredentials(): AwsCredentialIdentityProvider {
    ...
    if (accessKeyId && secretAccessKey) {
        ...
        // Return static credentials from environment variables
...
// Create the AWS Bedrock client with flexible credential configuration
